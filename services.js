...
// Harga adalah jasa saja. Estimasi menggunakan tanda ±.
...
globalThis.services = [
  {
    ...
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Scanning ECU","Pemeriksaan kondisi mesin","Pemeriksaan aki dan sistem pengisian","Pemeriksaan sistem udara","Pemeriksaan sistem pengapian"],
    cocokUntuk: "Kendaraan yang membutuhkan pemeriksaan dan perawatan performa mesin sesuai paket yang dipilih.",
    yangTidakTermasuk: ["Spare part","Oli mesin","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
  ...
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Semua layanan VG TUNE BASIC","Pembersihan throttle body","Pembersihan injector","Reset ECU bila diperlukan"],
    cocokUntuk: "Kendaraan yang membutuhkan pemeriksaan dan perawatan performa mesin sesuai paket yang dipilih.",
    yangTidakTermasuk: ["Spare part","Cairan pembersih tambahan","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Scanning ECU","Pemeriksaan Live Data","Pemeriksaan Fuel Trim","Pemeriksaan sensor mesin","Pemeriksaan performa mesin"],
    cocokUntuk: "Kendaraan yang membutuhkan pemeriksaan dan perawatan performa mesin sesuai paket yang dipilih.",
    yangTidakTermasuk: ["Spare part","Perbaikan kerusakan besar","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Scanning ECU","Pemeriksaan Live Data dasar","Pemeriksaan sistem udara","Pembersihan throttle body","Pembersihan EGR"],
    cocokUntuk: "Kendaraan yang membutuhkan pemeriksaan dan perawatan performa mesin sesuai paket yang dipilih.",
    yangTidakTermasuk: ["Filter solar","Oli mesin","Spare part","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Semua layanan VG TUNE BASIC Diesel","Pembersihan throttle body","Pembersihan EGR Valve","Pembersihan Intake Manifold","Pemeriksaan sistem udara"],
    cocokUntuk: "Kendaraan yang membutuhkan pemeriksaan dan perawatan performa mesin sesuai paket yang dipilih.",
    yangTidakTermasuk: ["Filter solar","Oli mesin","Spare part","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Semua layanan VG TUNE PLUS Diesel","Pembersihan Intercooler","Pemeriksaan sistem intake","Final Scan ECU","Pemeriksaan respons mesin"],
    cocokUntuk: "Kendaraan yang membutuhkan pemeriksaan dan perawatan performa mesin sesuai paket yang dipilih.",
    yangTidakTermasuk: ["Spare part","Servis injector diesel","Servis turbocharger","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pemeriksaan kondisi awal mesin","Proses carbon cleaner","Monitoring kondisi mesin","Pemeriksaan hasil pekerjaan"],
    cocokUntuk: "Kendaraan yang membutuhkan layanan tambahan sesuai kebutuhan setelah pemeriksaan atau servis utama.",
    yangTidakTermasuk: ["Kerusakan komponen mesin","Spare part","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pemeriksaan sistem bahan bakar","Pemasangan alat purging","Proses pembersihan sistem bahan bakar","Pemeriksaan hasil purging"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Cairan Diesel Purge","Penggantian injector","Perbaikan pompa injeksi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "vg-check",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pemeriksaan kondisi mesin","Pemeriksaan kebocoran oli dan coolant","Pemeriksaan sistem kelistrikan","Pemeriksaan sistem pendingin","Pemeriksaan sistem pengereman","Pemeriksaan suspensi dan kemudi","Scanning ECU kendaraan yang mendukung","Pemeriksaan hasil dan penjelasan kepada pelanggan"],
    cocokUntuk: "Kendaraan yang membutuhkan pemeriksaan awal untuk mengetahui kondisi dan indikasi gangguan.",
    yangTidakTermasuk: ["Biaya perbaikan","Spare part","Jasa servis lanjutan","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "vg-brake-service",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Bonus VG CHECK","Pembongkaran sistem rem","Pembersihan kaliper atau tromol","Pembersihan kampas rem","Pelumasan komponen rem","Penyetelan rem","Pemeriksaan minyak rem","Pemeriksaan akhir dan uji fungsi"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Penggantian kampas rem","Penggantian cakram atau tromol","Penggantian komponen rem","Minyak rem tambahan","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "vg-oil-service",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian oli mesin","Pemeriksaan kondisi oli lama","Pemeriksaan baut drain oli","Penggantian ring baut drain bila diperlukan","Pemeriksaan kebocoran oli","Reset service reminder bila tersedia"],
    cocokUntuk: "Kendaraan yang membutuhkan penggantian oli mesin dan pemeriksaan dasar sistem pelumasan.",
    yangTidakTermasuk: ["Oli mesin","Filter oli","Spare part tambahan","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Engine Flush","Membersihkan endapan lumpur oli","Membersihkan jalur pelumasan mesin","Pembuangan oli lama","Persiapan pengisian oli baru"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Oli mesin baru","Spare part","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-busi",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian busi","Pemeriksaan kondisi busi lama","Pemeriksaan celah busi","Pemeriksaan sistem pengapian","Uji performa mesin"],
    cocokUntuk: "Kendaraan dengan busi yang sudah mencapai interval penggantian, aus, kotor, atau mengalami gangguan pengapian.",
    yangTidakTermasuk: ["Busi","Kerusakan sistem pengapian lain","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian ignition coil","Pemeriksaan konektor coil","Pemeriksaan sistem pengapian","Uji percikan api","Uji performa mesin"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Ignition coil","Kerusakan ECU","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian engine mounting","Pemeriksaan mounting lainnya","Pemeriksaan baut mounting","Pemeriksaan getaran mesin","Uji kendaraan"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Spare part","Kerusakan dudukan lain","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-oli-mesin",
    ...
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian oli mesin","Pemeriksaan kondisi oli lama","Pemeriksaan baut drain oli","Penggantian ring baut drain bila diperlukan","Pemeriksaan kebocoran oli","Reset service reminder bila tersedia"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan oli dan sistem pelumasan.",
    yangTidakTermasuk: ["Oli mesin","Filter oli","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian oli transmisi manual","Pemeriksaan baut drain dan fill","Pemeriksaan kondisi oli lama","Pemeriksaan kebocoran oli transmisi"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Oli transmisi","Perbaikan transmisi","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian oli transmisi otomatis","Pemeriksaan baut drain dan fill","Pemeriksaan kondisi oli AT","Pemeriksaan kebocoran transmisi"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Oli AT","Filter transmisi","Perbaikan transmisi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-oli-gardan",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian oli gardan","Pemeriksaan baut drain dan fill","Pemeriksaan kondisi oli gardan","Pemeriksaan kebocoran oli"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Oli gardan","Perbaikan gardan","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pemeriksaan titik kebocoran oli","Pemeriksaan seal dan gasket","Penggantian seal/gasket bila diperlukan","Pembersihan area kebocoran","Pengujian setelah perbaikan"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan oli dan sistem pelumasan.",
    yangTidakTermasuk: ["Seal atau gasket","Kerusakan besar mesin","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pemeriksaan fuel pump","Pemeriksaan filter bahan bakar","Pemeriksaan injector","Pemeriksaan tekanan bahan bakar","Pemeriksaan kebocoran sistem bahan bakar"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Penggantian komponen","Spare part","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pembersihan jalur bahan bakar","Pembersihan injector","Pembersihan ruang bakar","Pemeriksaan sistem bahan bakar"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Spare part","Kerusakan injector","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-fuel-pump",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian fuel pump","Pemeriksaan tekanan bahan bakar","Pemeriksaan soket kelistrikan fuel pump","Pemeriksaan kebocoran","Uji sistem bahan bakar"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Fuel pump","Perbaikan kelistrikan besar","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "servis-injector",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pemeriksaan injector","Pembersihan injector","Pengujian pola semprotan","Pengujian debit injector","Pemeriksaan kebocoran injector"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Injector baru","Kerusakan sistem bahan bakar","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian shock absorber depan","Pemeriksaan dudukan shock","Pemeriksaan baut pengikat","Pemeriksaan kondisi suspensi"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Spare part","Kerusakan komponen lain","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian shock absorber belakang","Pemeriksaan dudukan shock","Pemeriksaan baut pengikat","Uji kendaraan"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Spare part","Perbaikan kaki-kaki lain","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-ball-joint",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian ball joint","Pemeriksaan steering knuckle","Pemeriksaan lower arm","Pemeriksaan baut pengikat"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Spare part","Kerusakan komponen lain","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian link stabilizer","Pemeriksaan karet stabilizer","Pemeriksaan stabilizer bar","Uji kendaraan"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Spare part","Perbaikan suspensi lain","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian bearing roda","Pemeriksaan hub roda","Pemeriksaan as roda","Pemeriksaan baut roda"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Spare part","Kerusakan hub roda","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-tie-rod",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian tie rod","Pemeriksaan rack end","Pemeriksaan boot steering rack","Uji fungsi kemudi"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Spare part","Spooring","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-rack-end",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian rack end","Pemeriksaan tie rod","Pemeriksaan steering rack","Uji fungsi kemudi"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Spare part","Spooring","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pembongkaran steering rack","Pembersihan komponen","Pemeriksaan gear rack","Penggantian seal kit bila diperlukan","Perakitan kembali","Uji fungsi kemudi"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Spare part tambahan","Kerusakan berat steering rack","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian power steering pump","Pemeriksaan belt power steering","Pemeriksaan selang power steering","Pemeriksaan kebocoran","Uji sistem power steering"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Spare part","Oli power steering","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pengurasan oli lama","Pengisian oli baru","Pemeriksaan kebocoran sistem","Uji fungsi kemudi"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Kerusakan power steering","Spare part","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "servis-rem",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Bongkar sistem rem","Pembersihan kampas rem","Pembersihan kaliper/tromol","Pelumasan komponen rem","Setel rem","Pemeriksaan minyak rem"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Penggantian spare part","Minyak rem","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian kampas rem depan","Pembersihan kaliper","Pelumasan pin kaliper","Pemeriksaan cakram rem","Uji fungsi rem"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Kampas rem","Kerusakan cakram","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian kampas rem belakang","Pembersihan tromol/kaliper","Pelumasan komponen rem","Pemeriksaan cakram/tromol","Uji fungsi rem"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Kampas rem","Kerusakan komponen lain","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pembongkaran kaliper","Pembersihan piston kaliper","Pemeriksaan seal kaliper","Pelumasan pin kaliper","Perakitan kembali","Uji fungsi rem"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Seal kit","Kaliper baru","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "flush-minyak-rem",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Menguras minyak rem lama","Pengisian minyak rem baru","Bleeding sistem rem","Pemeriksaan tekanan pedal rem","Pemeriksaan kebocoran"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Minyak rem","Perbaikan komponen rem rusak","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "kuras-radiator",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pengurasan coolant lama","Flushing sistem pendingin","Pengisian coolant baru","Pemeriksaan kebocoran sistem pendingin","Pemeriksaan tutup radiator"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Coolant","Penggantian komponen pendingin","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-radiator",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian radiator","Pemeriksaan selang radiator","Pemeriksaan tutup radiator","Pengisian coolant","Uji kebocoran sistem pendingin"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Radiator","Coolant","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-water-pump",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian water pump","Pemeriksaan gasket water pump","Pemeriksaan drive belt/timing belt","Pengisian coolant","Uji sistem pendingin"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Water pump","Coolant","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-thermostat",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian thermostat","Pemeriksaan housing thermostat","Pengisian coolant bila diperlukan","Pemeriksaan suhu kerja mesin","Pemeriksaan kebocoran"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Thermostat","Coolant","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian selang radiator","Pemeriksaan klem selang","Pengisian coolant bila diperlukan","Pemeriksaan kebocoran","Uji sistem pendingin"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Selang radiator","Coolant","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian oli transmisi manual","Pemeriksaan baut drain & fill","Pemeriksaan kondisi oli lama","Pemeriksaan kebocoran oli transmisi"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Oli transmisi","Perbaikan transmisi","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian oli transmisi otomatis","Pemeriksaan baut drain & fill","Pemeriksaan kondisi oli AT","Pemeriksaan kebocoran transmisi"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Oli AT","Kerusakan internal transmisi","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-kopling",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian kampas kopling","Pemeriksaan pressure plate","Pemeriksaan release bearing","Pemeriksaan flywheel","Penyetelan sistem kopling","Uji jalan kendaraan"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Komponen kopling","Kerusakan flywheel","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian master kopling","Pemeriksaan selang kopling","Bleeding sistem kopling","Uji fungsi kopling"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Master kopling","Oli hidrolik","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian boot drive shaft","Penggantian grease CV Joint","Pemeriksaan CV Joint","Pembersihan area CV Joint","Uji jalan kendaraan"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Boot drive shaft","Kerusakan CV Joint","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pemeriksaan kondisi aki","Pemeriksaan dinamo starter","Pemeriksaan relay starter","Pemeriksaan jalur kelistrikan","Pengukuran tegangan starter"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Penggantian komponen","Spare part","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pemeriksaan alternator","Pemeriksaan regulator","Pemeriksaan tegangan pengisian","Pemeriksaan aki","Analisa sistem charging"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Penggantian alternator","Penggantian aki","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-aki",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Penggantian aki","Pemeriksaan terminal aki","Pembersihan terminal aki","Pemeriksaan tegangan pengisian","Reset sistem elektronik bila diperlukan"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Aki baru","Kerusakan sistem charging","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pembongkaran alternator","Pembersihan komponen","Pemeriksaan rotor dan stator","Pemeriksaan bearing","Pemeriksaan carbon brush","Pengujian alternator"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Komponen pengganti","Alternator baru","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Pembongkaran dinamo starter","Pembersihan komponen","Pemeriksaan carbon brush","Pemeriksaan bendix","Pemeriksaan armature","Pengujian sistem starter"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Komponen pengganti","Dinamo starter baru","Biaya transportasi","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka pulley","Lepas seal lama","Bersihkan","Pasang seal baru"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Seal","Oli mesin tambahan","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Turunkan transmisi","Lepas flywheel","Ganti seal","Pasang kembali"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Seal","Oli transmisi","Gasket","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Turunkan A/T","Lepas flexplate","Ganti seal","Pasang"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Seal","ATF","Gasket","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka cover","Set TDC","Lepas belt lama","Pasang baru","Set timing"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Timing belt","Tensioner","Bearing","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka cover chain","Lepas guide","Pasang chain baru","Set timing"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Rantai","Guide","Tensioner","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka cover valve","Bersihkan","Pasang gasket baru","Kencangkan"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Gasket","Seal karet baut","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Dongkrak transmisi","Lepas support","Pasang baru"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Mounting baru","Baut","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-all-v-belt",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas semua v-belt","Pasang baru","Set tegangan"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Set v-belt (3-5 pcs)","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Kuras oli","Turunkan pan","Bersihkan","Pasang bak baru","Isi oli"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Bak oli","Seal/gasket","Oli mesin","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka head","Ganti valve seal","Laher klep","Gasket head","Setel"],
    cocokUntuk: "Kendaraan yang membutuhkan perawatan atau perbaikan pada mesin dan komponen pendukungnya.",
    yangTidakTermasuk: ["Part top kit","Gasket head","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas motor","Cabut konektor","Pasang baru","Tes sirkulasi"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Motor fan baru","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas motor depan","Pasang baru","Tes nyala AC"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Motor fan condensor","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas klem","Tarik selang","Pasang baru","Isi coolant"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Selang atas","Klem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas klem","Tarik selang bawah","Pasang baru","Isi coolant"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Selang bawah","Klem","Coolant","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas selang","Bersihkan fitting","Pasang baru"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Selang by-pass","Klem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka selang","Lepas rumah","Pasang baru","Isi coolant"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Water outlet/inlet","Gasket","Coolant","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-visco-fan",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka visco","Pasang baru","Kencangkan"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Visco fan baru","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka visco","Tambahkan silicon oil","Tutup rapat"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Silicon oil","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas kabel busi","Buka distributor","Pasang baru","Set timing"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Distributor baru","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka distributor","Ganti bearing","Seal","Platina","Bersihkan"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Part service kit","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka cap","Ganti rotor","Cap","Pasang kembali"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Rotor","Cap distributor","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "starter-system",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Cek kabel massa","Positif","Relay","Saklar","Motor starter"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Relay","Saklar","Kabel (jika ganti)","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "charging-system",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Cek tegangan","Dioda","Kabel utama","Fuse"],
    cocokUntuk: "Kendaraan dengan gangguan starter, charging, pengapian, atau kelistrikan mesin.",
    yangTidakTermasuk: ["Dioda","Regulator","Kabel","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka roda","Bersihkan","Beri grease","Setel hand & pedal brake"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Grease","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka 2 roda","Bersihkan","Setel"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Grease","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka tromol","Lepas sepatu","Kait","Spring","Pasang baru","Setel"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Sepatu","Spring kit","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka kaliper","Lepas disc","Pasang baru"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Disc rotor 1 pcs","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "over-houl-rem",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Bongkar kaliper/tromol","Ganti seal","Piston","Minyak rem baru","Bleed"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Seal kit","Minyak rem","Piston","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-master-rem",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas reservoir","Baut master","Pasang baru","Isi","Bleed"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Master rem","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka master","Ganti seal","Piston","Bersihkan","Pasang","Bleed"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Kit seal","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas master","Buka baut booster","Pasang baru"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Booster","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka kaliper","Ganti seal piston","Bersihkan","Pasang","Bleed"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Seal kit piston","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka komponen","Ganti seal/piston","Bersihkan","Pasang"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Seal kit","Piston","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka konsol","Lepas kabel","Pasang baru","Setel"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Kabel parking brake","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas motor servo","Pasang baru","Kalibrasi"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Motor servo","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas sambungan","Ganti proporsioner","Bleed"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Proporsioner","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas sensor","Pasang baru","Tes scanner"],
    cocokUntuk: "Kendaraan dengan rem kurang pakem, bunyi, getaran, atau membutuhkan perawatan sistem pengereman.",
    yangTidakTermasuk: ["Sensor ABS","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Bongkar master","Ganti seal","Bersihkan","Pasang","Bleed"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Kit seal","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas slave","Pasang baru","Bleed"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Slave silinder","Minyak rem","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Turunkan","Bongkar total","Ganti bearing","Synchromesh","Seal","Gasket"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Kit overhaul M/T","Oli","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Bongkar valve body","Ganti clutch pack","Band brake","Seal","ATF"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Kit overhaul A/T","ATF","Filter","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas drive shaft","Ganti seal di diff/transmisi","Pasang"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Seal","Oli/ATF","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas as","Bongkar CV luar","Ganti boot","Grease baru"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Boot kit","Grease","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas as","Bongkar joint dalam","Ganti boot","Grease"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Boot","Grease","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas as","Pasang baru","Isi oli diff"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Drive shaft assy","Oli diff","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka hub","Pres bearing","Pasang baru"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Bearing","Grease","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Ganti kedua bearing depan"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Bearing 2 pcs","Grease","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka hub","Pres bearing","Pasang"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Bearing","Grease","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Ganti kedua bearing belakang"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Bearing 2 pcs","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Dongkrak","Lepas","Pasang"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan atau perbaikan transmisi dan pemindah tenaga.",
    yangTidakTermasuk: ["Mounting","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka sambungan","Lepas rack","Pasang baru","Set alignment"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Rack assy","Oli PS","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Bongkar rack","Ganti seal","Bush","Rack bar","Setel"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Kit overhaul rack","Oli PS","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas selang","Buka pompa","Pasang baru","Isi oli","Bleed"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Pompa PS","Oli PS","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka pompa","Ganti seal","Bearing","Rotor","Tes tekanan"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Kit overhaul PS","Oli PS","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas motor EPS","Pasang baru","Kalibrasi"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Motor EPS / ECU","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas tie rod end","Pasang baru","Set toe-in"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Tie rod end","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas tie rod","Ganti boot","Pasang"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Boot rack","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas end & rack end","Pasang set"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Set tie rod","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas rack","Ganti grommet","Pasang"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Grommet","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas sambungan","Buka gear box","Pasang baru","Set play"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Steering gear box","Oli gear","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Bongkar","Ganti bearing","Seal","Worm gear","Set backlash"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Kit overhaul","Oli gear","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas selang hi-pressure","Pasang baru","Isi oli","Bleed"],
    cocokUntuk: "Kendaraan dengan kebutuhan perawatan sistem pendingin atau gejala suhu mesin tidak normal.",
    yangTidakTermasuk: ["Selang hi-pressure","Oli PS","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas joint","Pasang baru","Kencangkan"],
    cocokUntuk: "Kendaraan dengan kemudi berat, oblak, bunyi pada sistem kemudi, atau komponen steering yang aus.",
    yangTidakTermasuk: ["Yoke / joint","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas link","Pasang baru"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Link stabilizer","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas lateral rod","Pres bushing","Pasang"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Bushing lateral rod","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas bracket","Ganti karet","Pasang"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Karet stabilizer","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas lower arm","Pasang baru","Set alignment"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Lower arm","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Buka hub","Lengan","Knuckle","Pasang"],
    cocokUntuk: "Kendaraan dengan gejala bunyi kaki-kaki, getaran, limbung, atau komponen suspensi yang aus.",
    yangTidakTermasuk: ["Knuckle","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    id: "ganti-carburator",
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas karburator","Pasang baru","Set campuran"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Karburator","Gasket","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Bongkar","Bersihkan jet","Ganti gasket","Set idle & mixture"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Kit overhaul","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Turunkan tangki","Buang sisa","Bersihkan karat","Pasang"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Tangki","Bensin baru","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas filter","Pasang baru","Bleed"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Fuel filter","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas injector","Pasang baru","Cek pattern"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Injector","Seal copper","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas pompa","Tes bench","Ganti part","Setel"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Part service","Oli diesel","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  },
  {
    ...
    hargaKeterangan: "Harga jasa saja; belum termasuk spare part, bahan/material, dan pekerjaan tambahan di luar ruang lingkup layanan.",
    penyesuaianHarga: "Harga dapat menyesuaikan jenis, model, konstruksi, tingkat kesulitan, dan kondisi kendaraan.",
    yangTermasuk: ["Jasa pengerjaan sesuai layanan yang dipilih","Lepas injector","Test ultrasonic","Ganti filter","O-ring"],
    cocokUntuk: "Kendaraan dengan kebutuhan pemeriksaan, pembersihan, atau perbaikan sistem bahan bakar.",
    yangTidakTermasuk: ["Service kit","O-ring","Spare part/komponen pengganti","Kerusakan atau pekerjaan tambahan di luar ruang lingkup layanan","Biaya transportasi"],
    catatan: "Estimasi waktu bersifat perkiraan dan dapat berubah sesuai kondisi kendaraan, akses komponen, tingkat kerusakan, dan kebutuhan pekerjaan di lapangan."
  }
];
